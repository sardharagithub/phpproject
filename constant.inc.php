...
define('FRONT_SITE_PATH',"http://localhost/mca_1_p/food_ordering/");
define('SERVER_IMAGE',$_SERVER['DOCUMENT_ROOT']."/mca_1_p/food_ordering/");
...
//define('SITE_IMAGE',"http://localhost/mca_1_p/food_ordering/");
?>